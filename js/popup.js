...
var Lightbox = Class.create({
    ...
    initialize : function(containerDiv) {
        ...
        new Draggable(this.container, {handle: 'containerHead'});
...
function QuickLook(id){
    ...
    $('containerDiv').addClassName('loading');
    container.update('');
    var request = new Ajax.Request(
        '/quicklook/product/view/',{
            ...
            onComplete: function(transport){
                ...
                $('containerDiv').removeClassName('loading');
                //just launching embded javascript
                parseScript(content);
                Event.observe($("containerClose"), 'click', function () {
                    test.close();
                });
            }
        });
...
//parsing response for embded javascript
